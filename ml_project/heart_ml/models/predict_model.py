...
file_log = logging.FileHandler("data/interim/process_predict.log")
...
def predict_pipeline(predict_pipeline_params: PredictPipelineParams):
    ...
    logger.info(f"predict_features.shape is {predict_features.shape}")
    ...
    logger.info(f"predicted values were calculated with shape {predicts.shape}")
